          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 item">
              ...
              <div className="footer-desc">
                <p className="footer-text"> <a class="btn btn-outline-light btn-social mx-3" href="#!"><i class="fa-solid fa-phone"></i></a> 0712345678</p>
                <p className="footer-text"> <a class="btn btn-outline-light btn-social mx-3" href="https://www.instagram.com/g.a.d.s.o.n/"><i class="fab fa-fw fa-instagram"></i></a>car_connect_KE</p>
                <p className="footer-text"><a class="btn btn-outline-light btn-social mx-3" href="https://github.com/gaddie"><i className="fa-solid fa-envelope"></i></a> carconnect@gmail.com</p>
                <p className="footer-text"><a class="btn btn-outline-light btn-social mx-3" href="https://twitter.com/gadsonmulonga"><i class="fab fa-fw fa-twitter"></i></a> car_connect</p>
              </div>
